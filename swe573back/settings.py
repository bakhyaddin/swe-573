"""
Django settings for swe573back project.
...
SECRET_KEY = '$$zp=&-0ud_3y!l$x5nx70e&1+1@x2tmzlr_@q6xzny(s!$k7*'
...
WSGI_APPLICATION = 'swe573back.wsgi.application'
